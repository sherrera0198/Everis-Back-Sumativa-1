...
<div class="container" >
<div class="row">  <h1>Lista de Ventas </h1>   </div>
<br>
<br>
<table class=table>
	<thead>
	...
	<c:forEach var = "i" begin = "0" end = "${largoLista}">
			<tr>
			<th> <c:out value="${listaVentas[i].getId()}"></c:out> </th>
			<th><c:out value="${listaVentas[i].getIdUsuario()}"></c:out> </th>
			<th><c:out value="${listaVentas[i].getListaProductos()}"></c:out></th>
			<th><c:out value="${listaVentas[i].getFecha()}"></c:out></th>
